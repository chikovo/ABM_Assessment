...
def run_scraper():
    ...
    with sync_playwright() as p:
                ...
                for i, (cx, cy) in enumerate(centers):
                    ...
                    if visible_b64 and len(visible_b64) > 10:   
                        if visible_b64 not in visible_images_b64:
                            ...
                            print(f"  Visible Image {len(visible_images_b64)} found at ({cx}, {cy})")
        ...
        print(f"Saved {len(visible_images_b64)} VISIBLE images to 'visible_images_only.json'")
